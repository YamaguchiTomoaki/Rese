...
class ShopTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $param = [
            ...
            'image_id' => 'https://coachtech-matter.s3-ap-northeast-1.amazonaws.com/image/sushi.jpg'
        ];
        ...
        $param = [
            ...
            'image_id' => 'https://coachtech-matter.s3-ap-northeast-1.amazonaws.com/image/yakiniku.jpg'
        ];
        DB::table('shops')->insert($param);
        ...
        $param = [
            ...
            'image_id' => 'https://coachtech-matter.s3-ap-northeast-1.amazonaws.com/image/izakaya.jpg'
        ];
        DB::table('shops')->insert($param);
        ...
        $param = [
            ...
            'image_id' => 'https://coachtech-matter.s3-ap-northeast-1.amazonaws.com/image/italian.jpg'
        ];
        DB::table('shops')->insert($param);
        ...
        $param = [
            ...
            'image_id' => 'https://coachtech-matter.s3-ap-northeast-1.amazonaws.com/image/ramen.jpg'
        ];
        DB::table('shops')->insert($param);
